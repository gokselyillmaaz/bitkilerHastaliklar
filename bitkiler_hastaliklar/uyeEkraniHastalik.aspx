<%@ Page Title="" Language="C#" MasterPageFile="~/uye.Master" AutoEventWireup="true" CodeBehind="uyeEkraniHastalik.aspx.cs" Inherits="bitkiler_hastaliklar.uyeEkraniHastalik" %>
            ...
            <ItemTemplate>
                <tr style="height:50px">
                    ...
                    <td><asp:HyperLink ID="HyperLink2" 
                        NavigateUrl='<%# "~/uyeEkraniHastalikDetay.aspx?hastalikID="+Eval("hastalikID")%>'
