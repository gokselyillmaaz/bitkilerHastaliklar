<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="bitki_sil.aspx.cs" Inherits="bitkiler_hastaliklar.bitki_sil" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td><asp:HyperLink ID="HyperLink1" NavigateUrl='<%# "~/bitki_sil2.aspx?bitkiID="+Eval("bitkiID")%>' runat="server" CssClass="btn btn-danger">Sil</asp:HyperLink></td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
