<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="anaSayfaBitki.aspx.cs" Inherits="bitkiler_hastaliklar.anaSayfaBitki" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><asp:HyperLink ID="HyperLink2" 
                        NavigateUrl='<%# "~/anaSayfaBitkiDetay.aspx?bitkiID="+Eval("bitkiID")%>'
