<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="hastalik_guncelle2.aspx.cs" Inherits="bitkiler_hastaliklar.hastalik_guncelle2" %>
		...
		<div class="wrap p-l-30 p-r-30 p-t-10 p-b-30">
			<form class="login100-form validate-form" runat="server">
				...
				<div class="wrap-input100 validate-input m-b-20" >
                    <asp:TextBox ID="txtHastalikID" runat="server" CssClass="input100"
						placeholder="Hastalık ID" ReadOnly="true"></asp:TextBox>
					<span class="focus-input100" ></span>
				</div>

				<div class="wrap-input100 validate-input m-b-20" >
                    <asp:TextBox ID="txtHastalikAditr" runat="server" CssClass="input100"
						placeholder="Hastalık Adı (Türkçe)"></asp:TextBox>
					<span class="focus-input100" ></span>
				</div>

				<div class="wrap-input100 validate-input m-b-25" >
					<asp:TextBox ID="txtHastalikAdiLatin" runat="server"
						CssClass="input100" placeholder="Hastalık Adı (Latince)" ></asp:TextBox>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input m-b-25">
					<asp:TextBox ID="txtHastalikGrubu" runat="server"
						CssClass="input100" placeholder="Hastalık Grubu"></asp:TextBox>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input m-b-25" >
					<asp:TextBox ID="txtHastalikTanim" runat="server"
						CssClass="input100" placeholder="Hastalık Tanımı" ></asp:TextBox>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input m-b-25" >
					<asp:TextBox ID="txtHastalikAciklama" runat="server"
						CssClass="input100" placeholder="Açıklama" ></asp:TextBox>
					<span class="focus-input100"></span>
				</div>
